  ...
  // ─── STAGE 2: ROLE FOUNDATIONS ─────────────────────────────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: "6 min",
        content:
          "The Poa family includes both one of the most useful grasses in UK turf and one of the most troublesome weeds. Knowing which is which matters on every job.\n\n**Smooth-stalked meadow grass (Poa pratensis)**\nA rhizomatous species \u2014 it spreads underground, giving excellent self-repair and fill-in ability. Found in parks, sports surfaces and older domestic lawns. Hardy, dark green, tolerates close mowing. Slow to establish from seed but fills in well once rooted.\n\n- Spreads via rhizomes \u2014 can repair bare patches without overseeding\n- Good wear tolerance\n- Darker green than Poa annua\n- A desirable component in many lawn mixes\n\n**Annual meadow grass (Poa annua) \u2014 the weed species**\nUnlike its cousin, Poa annua is annual \u2014 it completes its life cycle in one year and seeds itself prolifically. It's one of the most common lawn weeds in the UK.\n\nYou'll recognise it by:\n- Pale, yellow-green colour compared to the surrounding grass\n- Seed heads visible even at low mowing heights\n- Flat, compressed habit \u2014 tends to lie along the ground\n- Often concentrated in worn, compacted or thin areas\n\n**There is no selective herbicide** that controls Poa annua without damaging the surrounding grass. Management is cultural only:\n- Avoid scalping \u2014 Poa annua thrives in low, stressed turf\n- Overseed densely to crowd it out \u2014 a thick sward is the best long-term defence\n- Aeration reduces the compaction that favours Poa annua establishment\n- Scarification removes some seed-bearing plants before they set seed\n\n**On a doorstep:** if a customer points out pale patches with visible seed heads, Poa annua is likely the cause. Set honest expectations \u2014 it requires ongoing cultural management, not a single treatment fix.",
      },
      {
        id: "gts-thatch-what",
